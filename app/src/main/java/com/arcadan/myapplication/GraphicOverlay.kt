...
import com.arcadan.myapplication.GraphicOverlay.Graphic
...
class GraphicOverlay(
    ...
    fun add(graphic: Graphic) {
        lock.withLock { graphics.add(graphic) }
    }
    ...
    fun remove(graphic: Graphic) {
        lock.withLock { graphics.remove(graphic) }
        postInvalidate()
    }
